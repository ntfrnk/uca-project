...
En esta otra imagen podemos ver encuadrados dos grupos de funcionalidades útiles para gestionar a los usuarios de la plataforma:
...
En la siguiente captura se puede ver el contenido de la opción "Configuración", donde el usuario logueado puede modificar sus datos de cuenta y contraseña.
...
Esta imagen es un ejemplo de la vista del detalle de cada curso.
