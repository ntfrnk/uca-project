...
@section('content')
    ...
    <div class="container">
        ...
        <div class="page-header mt30 d-flex justify-content-between">
            <h1>Profesores para este curso</h1>
            <div>
                <a href="{{ route('course.index') }}" class="btn btn-light mt10 mr5">
                    <x-Icon name="arrow_left" size="18" /> Volver al listado de cursos
                </a>
                <a href="{{ route('course.teachers.create', $course) }}" class="btn btn-primary mt10">
                    Agregar un profesor a este curso
                </a>
            </div>
        </div>
        ...
        <div class="pb80 pt15">
            ...
            <div class="d-flex row">
                ...
                @forelse($course->teachers->sortBy('pivot.role_id') as $user)

                    <div class="col-md-3 d-flex mb30">
                        <x-card-teacher :user="$user" :course="$course" />
                    </div>
                ...
                @empty
                    ...
                    <div class="em f18 ac py100 text-muted border">
                        ...
                        <p class="mt20">Aún no hay profesores para este curso</p>
                    </div>
